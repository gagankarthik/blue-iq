  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg/8 text-gray-600">We're here to help you get started with BlueIQ. Fill out the form below and a member of our team will reach out to you shortly.</p>
      </div>
