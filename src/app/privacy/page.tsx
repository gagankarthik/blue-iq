...
const sections: LegalSection[] = [
  ...
  { h: "Security", body: ["We maintain administrative, technical, and physical safeguards designed to protect personal information, and we maintain SOC 2 Type II controls. No method of transmission or storage is completely secure, but we work to protect information in line with industry standards."] },
  ...
  { h: "Your rights", body: ["Depending on your location, you may have rights to access, correct, delete, or port your personal information, and to object to or restrict certain processing. To exercise these rights, contact us at hello@blue-iq.com. If you are an authorized user of a Blue-IQ customer, please direct requests to that organization, which controls the relevant data."] },
  ...
  { h: "Contact", body: ["For privacy questions or requests, contact our privacy team at hello@blue-iq.com."] },
];
...
export default function PrivacyPage() {
  return (
    <LegalPage
      title="Privacy Policy"
      updated="May 23, 2026"
      intro="We take privacy seriously. This policy describes what information we collect, how we use it, and the choices and rights you have."
      sections={sections}
    />
  );
}
