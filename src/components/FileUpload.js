import { ArrowPathIcon, DocumentArrowUpIcon, ExclamationTriangleIcon, DocumentIcon } from '@heroicons/react/24/outline';
    ...
    <div className="max-w-4xl mx-auto animate-slide-up">
      ...
      <div className="text-center mb-8">
        <div className="flex items-center justify-center mb-4">
          <DocumentArrowUpIcon className="text-6xl text-ocean-blue mr-4 w-8" />
          <div>
      ...
      {error && (
        <div className="bg-red-50 border-l-4 border-red-400 text-red-700 p-6 mb-8 rounded-lg shadow-md animate-fade-in">
          <div className="flex items-start">
            <ExclamationTriangleIcon className="mt-1 mr-3 text-xl flex-shrink-0 w-6" />
            <div>
      ...
      >
        ...
        <div className="mb-6">
          <DocumentArrowUpIcon className={`mx-auto text-6xl transition-all duration-300 w-3  ${
      ...
      {file && (
        <div className=" rounded-xl p-6 mb-8 shadow-lg animate-fade-in">
          <div className="flex items-center">
            <DocumentIcon className="text-3xl mr-4 w-6" />
      ...
      {isProcessing && (
        <div className="bg-transparent border border-ocean-blue rounded-2xl p-8 mb-8 shadow-xl animate-fade-in">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <ArrowPathIcon className="animate-spin text-4xl text-black mr-4 w-4 " />
              <h3 className="text-2xl font-bold text-black">Processing Resume...</h3>
            </div>
      ...
      <div className="flex justify-center">
        <button 
          ...
          className={`px-8 py-4 rounded-xl text-white font-semibold text-lg flex items-center transition-all duration-300 transform hover:scale-105 ${
            file && !isProcessing 
              ? 'bg-blue-500 hover:from-blue-600 hover:to-blue-700 shadow-lg' 
              : 'bg-gray-400 cursor-not-allowed'
          }`}
        >
          {isProcessing ? (
            <>
              <ArrowPathIcon className="animate-spin mr-3 text-xl" />
              Processing...
            </>
          ) : (
            <>
              <DocumentArrowUpIcon className="mr-3 text-md w-9" />
              Process Resume
            </>
          )}
        </button>
