...
/* The Sonar engine, drawn as a chip with signal tracing through it. The moving
   glow along each trace is CSS motion-path (see globals.css → .cpu-line-*),
   because SVG masks alone cannot animate a light travelling a wire. */
  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <text x="100" y="51.8" textAnchor="middle" fontSize="4.5" fill={animateText ? "url(#cpu-text-gradient)" : "white"} fontWeight="600" letterSpacing="0.06em">
          {text}
        </text>
      </g>
