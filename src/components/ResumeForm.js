import { ArrowRightCircleIcon, PlusCircleIcon,TrashIcon } from '@heroicons/react/24/outline';
    ...
    <div className="max-w-4xl mx-auto animate-slide-up">
      ...
      <div className="flex justify-center mb-8">
        <button
          ...
          className="px-6 py-3 bg-blue-500 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg flex items-center transition-colors"
        >
          <ArrowRightCircleIcon className="mr-2 w-8" /> Generate Resume
        </button>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <section className="border border-gray-200 rounded-xl p-6 bg-gradient-to-r from-green-50 to-emerald-50 shadow-md">
          <div className="flex justify-between items-center mb-4">
            ...
            >
              <PlusCircleIcon className="mr-1 w-8" /> Add Education
            </button>
          </div>
          
          {formData.education && formData.education.map((edu, index) => (
            <div key={index} className="border rounded-md p-4 mb-4 bg-transparent">
        ...
        <section className="border rounded-lg p-6 bg-gray-50">
          <div className="flex justify-between items-center mb-4">
            ...
            >
              <PlusCircleIcon className="mr-1 w-8" /> Add Certification
            </button>
          </div>
        ...
        <section className="border rounded-lg p-6 bg-gray-50">
          <div className="flex justify-between items-center mb-4">
            ...
            <button 
              ...
              className="flex items-center text-blue-600 hover:text-blue-800"
            >
              <PlusCircleIcon className="mr-1 w-8" /> Add Employment
            </button>
          </div>
            ...
            <div key={index} className="border rounded-md p-4 mb-4 bg-transparent">
              ...
              <div className="mb-4">
                <div className="flex justify-between items-center mb-2">
                  ...
                  >
                    <PlusCircleIcon className="inline mr-1 w-8" /> Add Project
                  </button>
                </div>
                
                {job.projects && job.projects.map((project, projIndex) => (
                  <div key={projIndex} className="border rounded p-3 mb-3 bg-transparent">
                    <div className="flex justify-between items-center mb-2">
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <button 
                          ...
                          className="text-blue-600 hover:text-blue-800 text-sm"
                        >
                          <PlusCircleIcon className="inline mr-1 w-5" /> Add
                        </button>
                      </div>
              ...
              <div className="mt-4">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <button 
                    ...
                    className="text-blue-600 hover:text-blue-800 text-sm"
                  >
                    <PlusCircleIcon className="inline mr-1 w-8" /> Add Subsection
                  </button>
                </div>
                    ...
                    <div className="mt-2">
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <button 
                          ...
                          className="text-blue-600 hover:text-blue-800 text-sm"
                        >
                          <PlusCircleIcon className="inline mr-1 w-5" /> Add Point
                        </button>
                      </div>
        ...
        <section className="border rounded-lg p-6 bg-gray-50">
          <div className="flex justify-between items-center mb-4">
            ...
            <button 
              ...
              className="flex items-center text-blue-600 hover:text-blue-800"
            >
              <PlusCircleIcon className="mr-1 w-5" /> Add Point
            </button>
          </div>
          ...
          <div className="mt-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <button 
                ...
                className="text-blue-600 hover:text-blue-800 text-sm"
              >
                <PlusCircleIcon className="inline mr-1 w-5" /> Add Subsection
              </button>
            </div>
            
            {formData.summarySections && formData.summarySections.map((subsection, subIndex) => (
              <div key={subIndex} className="border rounded p-3 mb-3 bg-transparent">
                <div className="flex justify-between items-center mb-2">
                  <div className="flex-1 mr-2">
                    <label className="block text-sm font-medium text-gray-700 mb-1">Subsection Title</label>
                    <input
        ...
        <section className="border rounded-lg p-6 bg-gray-50">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="space-x-2">
              ...
              >
                <PlusCircleIcon className="mr-1 w-5" /> Add Simple Category
              </button>
              <button 
                type="button" 
              ...
              >
                <PlusCircleIcon className="mr-1 w-5" /> Add Nested Category
              </button>
            </div>
          </div>
              ...
              <div className="mt-3">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <button 
                    ...
                    className="text-blue-600 hover:text-blue-800 text-sm"
                  >
                    <PlusCircleIcon className="inline mr-1 w-5" /> Add Subcategory
                  </button>
                </div>
